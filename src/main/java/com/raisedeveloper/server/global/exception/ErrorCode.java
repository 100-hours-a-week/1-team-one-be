...
public enum ErrorCode {
	...
	// common
	// [400]
	INVALID_JSON(400, "INVALID_JSON", INVALID_JSON_MESSAGE),
	ACCESS_DENIED(403, "ACCESS_DENIED", ACCESS_DENIED_MESSAGE),
	RESOURCE_NOT_FOUND(404, "RESOURCE_NOT_FOUND", RESOURCE_NOT_FOUND_MESSAGE),
	METHOD_NOT_ALLOWED(405, "METHOD_NOT_ALLOWED", METHOD_NOT_ALLOWED_MESSAGE),
	UNSUPPORTED_MEDIA_TYPE(415, "UNSUPPORTED_MEDIA_TYPE", UNSUPPORTED_MEDIA_TYPE_MESSAGE),
	// [405],
	VALIDATION_FAILED(422, "VALIDATION_FAILED", VALIDATION_FAILED_MESSAGE),
	// [500]
	INTERNAL_SERVER_ERROR(500, "INTERNAL_SERVER_ERROR", INTERNAL_SERVER_ERROR_MESSAGE),

	// auth domain (JWT)
	ACCESS_TOKEN_EXPIRED(401, "JWT_ACCESS_EXPIRED", ACCESS_TOKEN_EXPIRED_MESSAGE),
	ACCESS_TOKEN_INVALID(401, "JWT_ACCESS_INVALID", ACCESS_TOKEN_INVALID_MESSAGE),
	REFRESH_TOKEN_EXPIRED(401, "JWT_REFRESH_EXPIRED", REFRESH_TOKEN_EXPIRED_MESSAGE),
	REFRESH_TOKEN_INVALID(401, "JWT_REFRESH_INVALID", REFRESH_TOKEN_INVALID_MESSAGE),
	MISSING_TOKEN(401, "JWT_MISSING", ACCESS_TOKEN_MISSING_MESSAGE),
